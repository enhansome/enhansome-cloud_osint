...
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,799 | 🐛 368 | 🌐 Python | 📅 2026-09-11 - Open-source cloud security tool for AWS, Azure, GCP, and Kubernetes with 300+ checks.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,957 | 🐛 17 | 🌐 Go | 📅 2026-09-11 - Query cloud infrastructure using SQL across AWS, Azure, GCP, and 100+ other services.
...
* [Cartography](https://github.com/lyft/cartography) ⭐ 4,052 | 🐛 122 | 🌐 Python | 📅 2026-09-12 - Consolidates infrastructure assets and relationships across cloud providers into a graph database.
...
* [enumerate-iam](https://github.com/andresriancho/enumerate-iam) ⭐ 1,259 | 🐛 17 | 🌐 Python | 📅 2024-02-05 - Enumerate IAM permissions for a given set of AWS credentials without logging.
...
* [lazys3](https://github.com/nahamsec/lazys3) ⭐ 636 | 🐛 8 | 🌐 Ruby | 📅 2024-02-01 - Brute-force AWS S3 bucket discovery using different permutations of common names.
...
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,420 | 🐛 6 | 🌐 Go | 📅 2026-09-11 - Fast passive subdomain enumeration tool using multiple online sources.
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,118 | 🐛 99 | 🌐 Go | 📅 2026-09-11 - Vulnerability scanner with cloud-specific templates for detecting misconfigurations.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,388 | 🐛 7 | 🌐 Go | 📅 2026-09-11 - Fast HTTP toolkit useful for probing discovered cloud endpoints at scale.
