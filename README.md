...
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,845 | 🐛 386 | 🌐 Python | 📅 2026-09-21 - Open-source cloud security tool for AWS, Azure, GCP, and Kubernetes with 300+ checks.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,961 | 🐛 20 | 🌐 Go | 📅 2026-09-17 - Query cloud infrastructure using SQL across AWS, Azure, GCP, and 100+ other services.
* [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,824 | 🐛 298 | 🌐 Python | 📅 2025-09-23 - Multi-cloud security auditing tool for AWS, Azure, GCP, Alibaba Cloud, and Oracle Cloud configurations.
* [Cartography](https://github.com/lyft/cartography) ⭐ 4,093 | 🐛 132 | 🌐 Python | 📅 2026-09-22 - Consolidates infrastructure assets and relationships across cloud providers into a graph database.
...
* [CloudEnum](https://github.com/initstring/cloud_enum) ⭐ 2,140 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - Multi-cloud OSINT tool that enumerates public resources across AWS, Azure, and GCP simultaneously.
...
* [Pacu](https://github.com/RhinoSecurityLabs/pacu) ⭐ 5,339 | 🐛 38 | 🌐 Python | 📅 2026-05-19 - AWS exploitation framework designed for offensive security testing of cloud environments.
* [S3Scanner](https://github.com/sa7mon/S3Scanner) ⭐ 3,171 | 🐛 41 | 🌐 Go | 📅 2026-08-03 - Scan for open S3 buckets, dump their contents, and check bucket permissions.
...
* [ROADtools](https://github.com/dirkjanm/ROADtools) ⭐ 2,723 | 🐛 13 | 🌐 Python | 📅 2026-08-05 - Framework for Azure AD reconnaissance and exploration of directory data.
...
* [AADInternals](https://github.com/Gerenios/AADInternals) ⭐ 1,695 | 🐛 23 | 🌐 PowerShell | 📅 2025-09-30 - PowerShell module for Azure AD and Office 365 administration, exploitation, and backdooring.
...
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,474 | 🐛 4 | 🌐 Go | 📅 2026-09-16 - Fast passive subdomain enumeration tool using multiple online sources.
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,414 | 🐛 104 | 🌐 Go | 📅 2026-09-21 - Vulnerability scanner with cloud-specific templates for detecting misconfigurations.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,415 | 🐛 11 | 🌐 Go | 📅 2026-09-16 - Fast HTTP toolkit useful for probing discovered cloud endpoints at scale.
