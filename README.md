# Awesome cloud osint with stars
...
| **🗂️ Asset Discovery**       | Bucket enumeration, subdomain discovery, storage scanning           | CloudEnum, cloud\_enum, S3Scanner, GrayhatWarfare |
...
| Oracle   | [public\_ip\_ranges.json](https://docs.oracle.com/en-us/iaas/tools/public_ip_ranges.json) | `curl -s https://docs.oracle.com/en-us/iaas/tools/public_ip_ranges.json`     |
...
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,765 | 🐛 378 | 🌐 Python | 📅 2026-09-04 - Open-source cloud security tool for AWS, Azure, GCP, and Kubernetes with 300+ checks.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,949 | 🐛 16 | 🌐 Go | 📅 2026-09-02 - Query cloud infrastructure using SQL across AWS, Azure, GCP, and 100+ other services.
* [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,810 | 🐛 298 | 🌐 Python | 📅 2025-09-23 - Multi-cloud security auditing tool for AWS, Azure, GCP, Alibaba Cloud, and Oracle Cloud configurations.
* [Cartography](https://github.com/lyft/cartography) ⭐ 4,041 | 🐛 117 | 🌐 Python | 📅 2026-09-05 - Consolidates infrastructure assets and relationships across cloud providers into a graph database.
* [CloudSploit](https://github.com/aquasecurity/cloudsploit) ⭐ 3,775 | 🐛 215 | 🌐 JavaScript | 📅 2026-08-31 - Cloud security posture management detecting misconfigurations across AWS, Azure, GCP, and Oracle.
* [CloudFox](https://github.com/BishopFox/cloudfox) ⭐ 2,574 | 🐛 10 | 🌐 Go | 📅 2026-08-20 - Automating situational awareness for cloud penetration testing across AWS, Azure, and GCP.
* [CloudEnum](https://github.com/initstring/cloud_enum) ⭐ 2,137 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - Multi-cloud OSINT tool that enumerates public resources across AWS, Azure, and GCP simultaneously.
* [CloudBrute](https://github.com/0xsha/CloudBrute) ⭐ 1,146 | 🐛 0 | 🌐 Go | 📅 2025-03-09 - Cloud infrastructure discovery tool supporting multiple providers with concurrent enumeration.

### AWS-Specific Tools

* [Pacu](https://github.com/RhinoSecurityLabs/pacu) ⭐ 5,320 | 🐛 37 | 🌐 Python | 📅 2026-05-19 - AWS exploitation framework designed for offensive security testing of cloud environments.
* [S3Scanner](https://github.com/sa7mon/S3Scanner) ⭐ 3,170 | 🐛 41 | 🌐 Go | 📅 2026-08-03 - Scan for open S3 buckets, dump their contents, and check bucket permissions.
* [AWSBucketDump](https://github.com/jordanpotti/AWSBucketDump) ⭐ 1,474 | 🐛 8 | 🌐 Python | 📅 2024-04-10 - Quickly enumerate AWS S3 buckets and search for interesting files within discovered buckets.
* [enumerate-iam](https://github.com/andresriancho/enumerate-iam) ⭐ 1,257 | 🐛 17 | 🌐 Python | 📅 2024-02-05 - Enumerate IAM permissions for a given set of AWS credentials without logging.
...
* [lazys3](https://github.com/nahamsec/lazys3) ⭐ 635 | 🐛 8 | 🌐 Ruby | 📅 2024-02-01 - Brute-force AWS S3 bucket discovery using different permutations of common names.

### Azure-Specific Tools

* [ROADtools](https://github.com/dirkjanm/ROADtools) ⭐ 2,712 | 🐛 13 | 🌐 Python | 📅 2026-08-05 - Framework for Azure AD reconnaissance and exploration of directory data.
* [MicroBurst](https://github.com/NetSPI/MicroBurst) ⭐ 2,436 | 🐛 5 | 🌐 PowerShell | 📅 2026-06-29 - PowerShell toolkit for attacking Azure services including storage, key vaults, and more.
* [Stormspotter](https://github.com/Azure/Stormspotter) ⭐ 1,717 | 🐛 23 | 🌐 Python | 📅 2024-01-08 - Azure AD and resource visualization tool for mapping attack paths.
* [AADInternals](https://github.com/Gerenios/AADInternals) ⭐ 1,690 | 🐛 23 | 🌐 PowerShell | 📅 2025-09-30 - PowerShell module for Azure AD and Office 365 administration, exploitation, and backdooring.

### GCP-Specific Tools

* [GCPBucketBrute](https://github.com/RhinoSecurityLabs/GCPBucketBrute) ⭐ 573 | 🐛 7 | 🌐 Python | 📅 2023-05-26 - Enumerate Google Storage buckets, determine access permissions, and check privilege escalation.
...
* [BucketLoot](https://github.com/redhuntlabs/BucketLoot) ⭐ 444 | 🐛 0 | 🌐 Go | 📅 2025-12-30 - Automated tool to inspect exposed storage buckets for sensitive data across cloud providers.
* [bucket\_finder](https://github.com/FishermansEnemy/bucket_finder) ⭐ 100 | 🐛 1 | 🌐 Ruby | 📅 2013-06-24 - Tool to bruteforce for the existence of AWS S3 buckets and check permissions.
...
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,391 | 🐛 17 | 🌐 Go | 📅 2026-09-02 - Fast passive subdomain enumeration tool using multiple online sources.
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,051 | 🐛 105 | 🌐 Go | 📅 2026-09-07 - Vulnerability scanner with cloud-specific templates for detecting misconfigurations.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,367 | 🐛 18 | 🌐 Go | 📅 2026-09-05 - Fast HTTP toolkit useful for probing discovered cloud endpoints at scale.
...
Looking for OSINT resources specific to **AI/ML infrastructure**? Check out our companion repository:

**[ai\_osint](https://github.com/7WaySecurity/ai_osint) ⭐ 163 | 🐛 0 | 📅 2026-06-19** — Google dorks, Shodan queries, and techniques to discover exposed LLM endpoints (Ollama, vLLM), leaked AI API keys (OpenAI, Anthropic, Gemini), misconfigured vector databases (Qdrant, Weaviate, ChromaDB), unprotected AI agents (MCP servers, OpenClaw), and more.
