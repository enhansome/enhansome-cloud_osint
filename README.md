...
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,838 | 🐛 378 | 🌐 Python | 📅 2026-09-19 - Open-source cloud security tool for AWS, Azure, GCP, and Kubernetes with 300+ checks.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,957 | 🐛 20 | 🌐 Go | 📅 2026-09-17 - Query cloud infrastructure using SQL across AWS, Azure, GCP, and 100+ other services.
* [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,822 | 🐛 298 | 🌐 Python | 📅 2025-09-23 - Multi-cloud security auditing tool for AWS, Azure, GCP, Alibaba Cloud, and Oracle Cloud configurations.
* [Cartography](https://github.com/lyft/cartography) ⭐ 4,090 | 🐛 132 | 🌐 Python | 📅 2026-09-19 - Consolidates infrastructure assets and relationships across cloud providers into a graph database.
* [CloudSploit](https://github.com/aquasecurity/cloudsploit) ⭐ 3,776 | 🐛 212 | 🌐 JavaScript | 📅 2026-09-07 - Cloud security posture management detecting misconfigurations across AWS, Azure, GCP, and Oracle.
* [CloudFox](https://github.com/BishopFox/cloudfox) ⭐ 2,579 | 🐛 10 | 🌐 Go | 📅 2026-08-20 - Automating situational awareness for cloud penetration testing across AWS, Azure, and GCP.
* [CloudEnum](https://github.com/initstring/cloud_enum) ⭐ 2,141 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - Multi-cloud OSINT tool that enumerates public resources across AWS, Azure, and GCP simultaneously.
* [CloudBrute](https://github.com/0xsha/CloudBrute) ⭐ 1,148 | 🐛 0 | 🌐 Go | 📅 2025-03-09 - Cloud infrastructure discovery tool supporting multiple providers with concurrent enumeration.

### AWS-Specific Tools

* [Pacu](https://github.com/RhinoSecurityLabs/pacu) ⭐ 5,336 | 🐛 38 | 🌐 Python | 📅 2026-05-19 - AWS exploitation framework designed for offensive security testing of cloud environments.
...
* [lazys3](https://github.com/nahamsec/lazys3) ⭐ 638 | 🐛 8 | 🌐 Ruby | 📅 2024-02-01 - Brute-force AWS S3 bucket discovery using different permutations of common names.
...
* [MicroBurst](https://github.com/NetSPI/MicroBurst) ⭐ 2,441 | 🐛 5 | 🌐 PowerShell | 📅 2026-06-29 - PowerShell toolkit for attacking Azure services including storage, key vaults, and more.
...
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,464 | 🐛 4 | 🌐 Go | 📅 2026-09-16 - Fast passive subdomain enumeration tool using multiple online sources.
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,322 | 🐛 106 | 🌐 Go | 📅 2026-09-18 - Vulnerability scanner with cloud-specific templates for detecting misconfigurations.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,414 | 🐛 11 | 🌐 Go | 📅 2026-09-16 - Fast HTTP toolkit useful for probing discovered cloud endpoints at scale.
