...
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,823 | 🐛 380 | 🌐 Python | 📅 2026-09-16 - Open-source cloud security tool for AWS, Azure, GCP, and Kubernetes with 300+ checks.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,955 | 🐛 18 | 🌐 Go | 📅 2026-09-16 - Query cloud infrastructure using SQL across AWS, Azure, GCP, and 100+ other services.
* [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,818 | 🐛 298 | 🌐 Python | 📅 2025-09-23 - Multi-cloud security auditing tool for AWS, Azure, GCP, Alibaba Cloud, and Oracle Cloud configurations.
* [Cartography](https://github.com/lyft/cartography) ⭐ 4,071 | 🐛 121 | 🌐 Python | 📅 2026-09-16 - Consolidates infrastructure assets and relationships across cloud providers into a graph database.
* [CloudSploit](https://github.com/aquasecurity/cloudsploit) ⭐ 3,774 | 🐛 212 | 🌐 JavaScript | 📅 2026-09-07 - Cloud security posture management detecting misconfigurations across AWS, Azure, GCP, and Oracle.
* [CloudFox](https://github.com/BishopFox/cloudfox) ⭐ 2,578 | 🐛 10 | 🌐 Go | 📅 2026-08-20 - Automating situational awareness for cloud penetration testing across AWS, Azure, and GCP.
* [CloudEnum](https://github.com/initstring/cloud_enum) ⭐ 2,139 | 🐛 0 | 🌐 Python | 📅 2026-07-09 - Multi-cloud OSINT tool that enumerates public resources across AWS, Azure, and GCP simultaneously.
...
* [Pacu](https://github.com/RhinoSecurityLabs/pacu) ⭐ 5,331 | 🐛 38 | 🌐 Python | 📅 2026-05-19 - AWS exploitation framework designed for offensive security testing of cloud environments.
* [S3Scanner](https://github.com/sa7mon/S3Scanner) ⭐ 3,172 | 🐛 41 | 🌐 Go | 📅 2026-08-03 - Scan for open S3 buckets, dump their contents, and check bucket permissions.
...
* [enumerate-iam](https://github.com/andresriancho/enumerate-iam) ⭐ 1,260 | 🐛 17 | 🌐 Python | 📅 2024-02-05 - Enumerate IAM permissions for a given set of AWS credentials without logging.
...
* [lazys3](https://github.com/nahamsec/lazys3) ⭐ 637 | 🐛 8 | 🌐 Ruby | 📅 2024-02-01 - Brute-force AWS S3 bucket discovery using different permutations of common names.
...
* [MicroBurst](https://github.com/NetSPI/MicroBurst) ⭐ 2,442 | 🐛 5 | 🌐 PowerShell | 📅 2026-06-29 - PowerShell toolkit for attacking Azure services including storage, key vaults, and more.
* [Stormspotter](https://github.com/Azure/Stormspotter) ⭐ 1,720 | 🐛 23 | 🌐 Python | 📅 2024-01-08 - Azure AD and resource visualization tool for mapping attack paths.
* [AADInternals](https://github.com/Gerenios/AADInternals) ⭐ 1,693 | 🐛 23 | 🌐 PowerShell | 📅 2025-09-30 - PowerShell module for Azure AD and Office 365 administration, exploitation, and backdooring.
...
* [BucketLoot](https://github.com/redhuntlabs/BucketLoot) ⭐ 445 | 🐛 0 | 🌐 Go | 📅 2025-12-30 - Automated tool to inspect exposed storage buckets for sensitive data across cloud providers.
...
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,440 | 🐛 3 | 🌐 Go | 📅 2026-09-16 - Fast passive subdomain enumeration tool using multiple online sources.
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,320 | 🐛 105 | 🌐 Go | 📅 2026-09-15 - Vulnerability scanner with cloud-specific templates for detecting misconfigurations.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,400 | 🐛 10 | 🌐 Go | 📅 2026-09-16 - Fast HTTP toolkit useful for probing discovered cloud endpoints at scale.
