...
* [Prowler](https://github.com/prowler-cloud/prowler) ⭐ 14,610 | 🐛 274 | 🌐 Python | 📅 2026-08-17 - Open-source cloud security tool for AWS, Azure, GCP, and Kubernetes with 300+ checks.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,917 | 🐛 22 | 🌐 Go | 📅 2026-08-17 - Query cloud infrastructure using SQL across AWS, Azure, GCP, and 100+ other services.
* [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,793 | 🐛 295 | 🌐 Python | 📅 2025-09-23 - Multi-cloud security auditing tool for AWS, Azure, GCP, Alibaba Cloud, and Oracle Cloud configurations.
* [Cartography](https://github.com/lyft/cartography) ⭐ 4,010 | 🐛 99 | 🌐 Python | 📅 2026-08-17 - Consolidates infrastructure assets and relationships across cloud providers into a graph database.
* [CloudSploit](https://github.com/aquasecurity/cloudsploit) ⭐ 3,766 | 🐛 212 | 🌐 JavaScript | 📅 2026-07-28 - Cloud security posture management detecting misconfigurations across AWS, Azure, GCP, and Oracle.
* [CloudFox](https://github.com/BishopFox/cloudfox) ⭐ 2,557 | 🐛 12 | 🌐 Go | 📅 2026-05-26 - Automating situational awareness for cloud penetration testing across AWS, Azure, and GCP.
...
* [enumerate-iam](https://github.com/andresriancho/enumerate-iam) ⭐ 1,250 | 🐛 17 | 🌐 Python | 📅 2024-02-05 - Enumerate IAM permissions for a given set of AWS credentials without logging.
...
* [MicroBurst](https://github.com/NetSPI/MicroBurst) ⭐ 2,419 | 🐛 5 | 🌐 PowerShell | 📅 2026-06-29 - PowerShell toolkit for attacking Azure services including storage, key vaults, and more.
...
* [AADInternals](https://github.com/Gerenios/AADInternals) ⭐ 1,679 | 🐛 23 | 🌐 PowerShell | 📅 2025-09-30 - PowerShell module for Azure AD and Office 365 administration, exploitation, and backdooring.
...
* [Subfinder](https://github.com/projectdiscovery/subfinder) ⭐ 14,219 | 🐛 8 | 🌐 Go | 📅 2026-08-12 - Fast passive subdomain enumeration tool using multiple online sources.
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,569 | 🐛 104 | 🌐 Go | 📅 2026-08-17 - Vulnerability scanner with cloud-specific templates for detecting misconfigurations.
* [httpx](https://github.com/projectdiscovery/httpx) ⭐ 10,285 | 🐛 10 | 🌐 Go | 📅 2026-08-15 - Fast HTTP toolkit useful for probing discovered cloud endpoints at scale.
